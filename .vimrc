...
NeoBundle 'https://github.com/thinkpixellab/flatland', {
      \ 'rtp': 'vim'
      \ }
NeoBundle 'john2x/flatui.vim'
NeoBundle 'jdkanani/vim-material-theme'
NeoBundle 'x1596357/vim'
NeoBundle 'trusktr/seti.vim'

NeoBundle 'https://github.com/daylerees/colour-schemes', {
      \ 'rtp': 'vim'
      \ }
...
let g:tagbar_phpctags_bin='~/vimset/phpctags/phpctags'
...
" window switching
noremap <silent> <C-w-l> <c-w>l
noremap <silent> <C-w-j> <c-w>j
noremap <silent> <C-w-k> <c-w>k
noremap <silent> <C-w-h> <c-w>h

noremap <silent> <C-s-l> :bn<cr>
noremap <silent> <C-s-j> :tabp<cr>
noremap <silent> <C-s-k> :tabn<cr>
noremap <silent> <C-s-h> :bp<cr>
